...
//         Route::get('/schools',   fn() => view('superadmin.schools.index'))->name('schools.index');
//         Route::get('/users',     fn() => view('superadmin.users.index'))->name('users.index');
//         Route::get('/analytics', fn() => view('superadmin.analytics'))->name('analytics');
//         Route::get('/settings',  fn() => view('superadmin.settings'))->name('settings');
//     });
...
//         Route::patch('/transactions/{borrowing}/return', [AdminTransaction::class, 'processReturn'])->name('transactions.return');
...
//         Route::get('/history',   fn() => view('student.history'))->name('history');
//         Route::get('/profile',   fn() => view('student.profile'))->name('profile');
//         Route::get('/wishlist',  fn() => view('student.wishlist'))->name('wishlist');
