        ...
        <div class="register-content">
            ...
            <div class="mb-12 fade-up" style="animation-delay: 0.1s">
                <a href="{{ route('landing') }}" class="flex items-center gap-3 mb-12">
                    ...
                    <div class="flex flex-col leading-tight">
                        <span class="text-white/80 text-xs font-semibold tracking-wider">RUANG</span>
                        <span class="text-white text-2xl font-bold tracking-tight">BACA</span>
                    </div>
                </a>
            </div>
            ...
            <div class="mb-12 fade-up" style="animation-delay: 0.2s">
                ...
                <p class="text-white/70 text-lg leading-relaxed">
                    Bergabunglah dengan ribuan siswa yang sudah merasakan kemudahan mengakses koleksi buku digital kapan saja, di mana saja.
                </p>
            </div>
        ...
        <div class="register-content">
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="full_name" value="{{ old('full_name') }}" placeholder="Masukkan nama lengkap Anda" class="form-input" required>
                </div>

                <!-- Username -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Username <span class="text-red-500">*</span></label>
                    <input type="text" name="username" value="{{ old('username') }}" placeholder="Pilih username unik" class="form-input" required>
                    <p class="mt-1 text-xs text-gray-400">Username harus unik dan tidak boleh sama dengan yang lain</p>
                </div>

                <!-- Email -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Email <span class="text-gray-400">(Opsional)</span></label>
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="email@contoh.com" class="form-input">
                </div>
                ...
                <!-- Password -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Kata Sandi <span class="text-red-500">*</span></label>
                    <div class="relative">
                        <input type="password" name="password" id="password" placeholder="Minimal 8 karakter" class="form-input pr-12" required>
                ...
                <!-- Confirm Password -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Konfirmasi Kata Sandi <span class="text-red-500">*</span></label>
                    <div class="relative">
                        <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Ulangi kata sandi" class="form-input pr-12" required>
                ...
                <div class="flex items-start gap-3">
                    <input type="checkbox" id="terms" name="terms" class="w-4 h-4 mt-0.5 text-evergreen-600 rounded" required>
                    <label for="terms" class="text-sm text-gray-600">
                        Saya setuju dengan <a href="#" class="text-evergreen-600 hover:text-evergreen-700 font-medium">Syarat & Ketentuan</a> serta <a href="#" class="text-evergreen-600 hover:text-evergreen-700 font-medium">Kebijakan Privasi</a>
                    </label>
                </div>
            ...
            <div class="mt-6 text-center">
                <a href="{{ route('landing') }}" class="text-sm text-gray-400 hover:text-evergreen-600 transition">
