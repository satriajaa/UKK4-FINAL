...
@section('content')
    ...
    @php
        ...
        $activeBorrow = \App\Models\Borrowing::where('user_id', $user->id)
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden mb-5">
            ...
            <div class="flex flex-col items-center -mt-14 pb-6 px-6">
                ...
                {{-- Avatar --}}
                <div class="avatar-wrap relative cursor-pointer mb-3"
                    onclick="document.getElementById('photo-input').click()">
                    <div class="avatar-ring">
                        <div class="avatar-inner">
                            @if ($user->photo)
                                <img src="{{ asset('storage/' . $user->photo) }}" id="avatar-preview"
                                    class="w-24 h-24 object-cover rounded-full" alt="{{ $user->full_name }}">
                            @else
                    ...
                    <div class="avatar-overlay absolute inset-0 flex items-center justify-center">
                        <div
                            class="w-8 h-8 bg-evergreen-600 rounded-full flex items-center justify-center shadow-lg border-2 border-white absolute bottom-1 right-1">
                ...
                <div class="flex gap-3 mt-4">
                    <button onclick="switchSection('profile')" id="btn-profile"
                    ...
                    <button onclick="switchSection('password')" id="btn-password"
                ...
                <form method="POST" action="{{ route('student.profile.update') }}" enctype="multipart/form-data"
                    ...
                    <div class="mt-4 grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <div
                                class="px-4 py-2.5 bg-gray-50 border border-dashed border-gray-200 rounded-xl text-sm text-gray-500">
                                {{ $user->student_id ?? '—' }}
                            </div>
                        </div>
                        <div>
        ...
        <div id="section-password" class="tab-section section-anim">
            <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-6">
                ...
                @if (session('password_error'))
                    <div
                        class="mb-4 flex items-center gap-2 bg-red-50 border border-red-200 text-red-700 rounded-xl px-4 py-3 text-sm">
                ...
                <form method="POST" action="{{ route('student.profile.password') }}" id="password-form">
                    ...
                    <div class="mb-2">
                        ...
                        <div class="relative">
                            <input type="password" name="password" id="new-pwd" placeholder="Minimal 8 karakter"
                    ...
                    <div class="bg-blue-50 border border-blue-100 rounded-xl p-3 mb-6 text-xs text-blue-700 space-y-1">
                        <div class="font-semibold mb-1"><i class="fas fa-shield-halved mr-1"></i> Tips Keamanan Password
                        </div>
